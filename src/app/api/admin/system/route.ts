...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      quickLinks: [
        { href: "/admin/marketing?mode=website&tab=trust", label: "Thành tựu & uy tín", group: "Nội dung trang" },
        { href: "/admin/marketing?mode=website&tab=community", label: "Hoạt động cộng đồng", group: "Nội dung trang" },
        { href: "/admin/settings", label: "Cấu hình Web", group: "Hệ thống" },
        { href: "/admin/marketing?mode=website&tab=history", label: "Lịch sử phát triển", group: "Nội dung trang" },
        { href: "/admin/marketing?mode=website&tab=home&scope=home", label: "Trang chủ", group: "Nội dung trang" },
