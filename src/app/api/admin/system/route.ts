...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      quickLinks: [
        { href: "/admin/website/about/trust", label: "Thành tựu & uy tín", group: "Nội dung trang" },
        { href: "/admin/website/about/community", label: "Hoạt động cộng đồng", group: "Nội dung trang" },
        { href: "/admin/settings", label: "Cấu hình Web", group: "Hệ thống" },
        { href: "/admin/website/about/history", label: "Lịch sử phát triển", group: "Nội dung trang" },
        { href: "/admin/website/home", label: "Trang chủ", group: "Nội dung trang" },
