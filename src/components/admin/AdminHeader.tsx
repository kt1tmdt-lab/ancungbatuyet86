    ...
    <>
        ...
        <div className="px-4 sm:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Link href="/admin" className="flex items-center gap-2">
              <div className="w-9 h-9 overflow-hidden rounded-full border border-slate-700 flex items-center justify-center bg-white shadow-md shadow-orange-500/10">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 text-xs font-semibold text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition border border-transparent hover:border-red-500/20"
            >
              <LogOut size={14} />
        ...
        {sidebarOpen && (
          <div className="lg:hidden bg-slate-900 border-t border-slate-800 shadow-xl py-3 px-4 animate-fade-in">
            ...
            <div className="mt-4 pt-3 border-t border-slate-800">
              <button
                onClick={handleLogout}
                className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold text-red-400 hover:bg-red-500/10 transition"
              >
                <LogOut size={18} />
                <span>Đăng xuất</span>
              </button>
      ...
      <aside className="hidden lg:flex lg:fixed left-0 top-16 bottom-0 w-64 bg-slate-900 border-r border-slate-800 p-4 z-30 flex-col justify-between">
        <div className="space-y-6">
          <div className="px-3 py-2 bg-slate-800/40 rounded-xl border border-slate-800/60 flex items-center gap-3">
        ...
        <div className="pt-4 border-t border-slate-800 space-y-3">
          <button
            onClick={handleLogout}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-red-400 hover:text-white hover:bg-red-500 transition-all border border-red-500/20 hover:border-transparent"
          >
            <LogOut size={16} />
            <span>Đăng xuất</span>
          </button>
