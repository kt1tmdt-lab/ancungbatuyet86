...
export const DEFAULT_HOME_TEXTS: HomeTextItem[] = [
  ...
  { id: "about-text-story-label", key: "about_story_label", group: "Giới thiệu - Câu chuyện thương hiệu", label: "Nhãn câu chuyện", value: "Câu chuyện thương hiệu", multiline: false, sortOrder: 602 },
  ...
  { id: "about-text-values-label", key: "about_values_label", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Nhãn cụm", value: "Định hướng thương hiệu", multiline: false, sortOrder: 621 },
  { id: "about-text-values-title", key: "about_values_title", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Tiêu đề cụm", value: "Sứ mệnh, tầm nhìn và giá trị cốt lõi.", multiline: true, sortOrder: 622 },
  { id: "about-text-values-description", key: "about_values_description", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Mô tả cụm", value: "Ăn Cùng Bà Tuyết được xây dựng trên nền tảng của sự chân thật: làm sạch, bán thật, phục vụ tử tế và phát triển bền vững.", multiline: true, sortOrder: 623 },
  { id: "about-text-value-1-title", key: "about_value_1_title", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Thẻ 1 - tiêu đề", value: "Sứ mệnh", multiline: false, sortOrder: 624 },
  { id: "about-text-value-1-description", key: "about_value_1_description", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Thẻ 1 - mô tả", value: "Đưa đồ ăn vặt Việt Nam đến gần hơn với người tiêu dùng bằng sản phẩm rõ nguồn gốc, hương vị gần gũi và cách làm minh bạch.", multiline: true, sortOrder: 625 },
  { id: "about-text-value-2-title", key: "about_value_2_title", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Thẻ 2 - tiêu đề", value: "Tầm nhìn", multiline: false, sortOrder: 626 },
  { id: "about-text-value-2-description", key: "about_value_2_description", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Thẻ 2 - mô tả", value: "Trở thành thương hiệu ăn vặt Việt được nhận diện bằng chất lượng ổn định, quy trình bài bản và niềm tin của khách hàng.", multiline: true, sortOrder: 627 },
  { id: "about-text-value-3-title", key: "about_value_3_title", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Thẻ 3 - tiêu đề", value: "Giá trị cốt lõi", multiline: false, sortOrder: 628 },
  { id: "about-text-value-3-description", key: "about_value_3_description", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Thẻ 3 - mô tả", value: "Chân thật trong truyền thông, kỹ trong sản xuất, chỉn chu trong đóng gói và tử tế với từng khách hàng.", multiline: true, sortOrder: 629 },
  { id: "about-text-value-4-title", key: "about_value_4_title", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Thẻ 4 - tiêu đề", value: "Con người", multiline: false, sortOrder: 630 },
  { id: "about-text-value-4-description", key: "about_value_4_description", group: "Giới thiệu - Sứ mệnh và giá trị", label: "Thẻ 4 - mô tả", value: "Đội ngũ sản xuất, kho vận, livestream và chăm sóc khách hàng cùng vận hành thương hiệu từ những công việc cụ thể mỗi ngày.", multiline: true, sortOrder: 631 },
