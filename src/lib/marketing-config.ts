...
export const PRODUCTS_LANDING_DESCRIPTION =
  "Chân gà rút xương, tăm cay, bánh tráng và nhiều món ăn vặt khác. Chọn sản phẩm bạn thích để xem thành phần, hương vị và quy cách đóng gói.";

const LEGACY_PRODUCTS_LANDING_DESCRIPTION =
...
export const DEFAULT_HOME_TEXTS: HomeTextItem[] = [
  ...
  { id: "products-landing-description", key: "products_landing_description", group: "Trang Sản phẩm - Hero", label: "Mô tả đầu trang", value: PRODUCTS_LANDING_DESCRIPTION, multiline: true, sortOrder: 4 },
  ...
  { id: "about-hero-title", key: "about_hero_title", group: "Giới thiệu - Hero hồ sơ thương hiệu", label: "Tiêu đề lớn", value: "Ăn Cùng Bà Tuyết: Thương hiệu Việt, vì người Việt", multiline: true, sortOrder: 602 },
  { id: "about-hero-description", key: "about_hero_description", group: "Giới thiệu - Hero hồ sơ thương hiệu", label: "Mô tả", value: "Thương hiệu đồ ăn vặt Việt Nam sản xuất tại nhà máy đạt tiêu chuẩn An toàn Vệ sinh thực phẩm & ISO 22000:2018, phân phối toàn quốc qua hệ thống bán lẻ và thương mại điện tử.", multiline: true, sortOrder: 603 },
  ...
  { id: "about-hero-stat-1-value", key: "about_hero_stat_1_value", group: "Giới thiệu - Hero hồ sơ thương hiệu", label: "Số liệu 1 - giá trị", value: "15+ triệu", multiline: false, sortOrder: 608 },
  { id: "about-hero-stat-1-label", key: "about_hero_stat_1_label", group: "Giới thiệu - Hero hồ sơ thương hiệu", label: "Số liệu 1 - mô tả", value: "đơn hàng", multiline: true, sortOrder: 609 },
  { id: "about-hero-stat-2-value", key: "about_hero_stat_2_value", group: "Giới thiệu - Hero hồ sơ thương hiệu", label: "Số liệu 2 - giá trị", value: "50.000+", multiline: false, sortOrder: 610 },
  { id: "about-hero-stat-2-label", key: "about_hero_stat_2_label", group: "Giới thiệu - Hero hồ sơ thương hiệu", label: "Số liệu 2 - mô tả", value: "điểm bán toàn quốc", multiline: true, sortOrder: 611 },
  { id: "about-hero-stat-3-value", key: "about_hero_stat_3_value", group: "Giới thiệu - Hero hồ sơ thương hiệu", label: "Số liệu 3 - giá trị", value: "10 triệu+", multiline: false, sortOrder: 612 },
  { id: "about-hero-stat-3-label", key: "about_hero_stat_3_label", group: "Giới thiệu - Hero hồ sơ thương hiệu", label: "Số liệu 3 - mô tả", value: "người theo dõi", multiline: true, sortOrder: 613 },
  ...
  { id: "about-current-story-title", key: "about_current_story_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Tiêu đề hành trình", value: "Từ người nông dân Thái Nguyên đến thương hiệu đồ ăn vặt Việt Nam", multiline: true, sortOrder: 661 },
  { id: "about-current-story-1", key: "about_current_story_1", group: "Giới thiệu - Nội dung đang hiển thị", label: "Câu chuyện - đoạn 1", value: "Bà Tuyết Diamond - Đỗ Thị Tuyết - xuất phát điểm là một nông dân ở Thái Nguyên. Công việc hằng ngày của bà là làm ruộng và trồng chè. Gia đình từng gánh khoản nợ hàng trăm triệu đồng từ việc sửa nhà, chữa bệnh và chăn nuôi thất bại. Năm 2014, một tai nạn gãy chân khiến bà phải ở nhà suốt hai năm, mất đi cơ hội làm việc ổn định.", multiline: true, sortOrder: 662 },
  { id: "about-current-story-2", key: "about_current_story_2", group: "Giới thiệu - Nội dung đang hiển thị", label: "Câu chuyện - đoạn 2", value: "Cuối năm 2020, con trai bà - Nguyễn Minh Trường - bắt đầu rủ mẹ cùng tham gia quay video đời thường. Bằng chiếc điện thoại cũ, những thước phim về cuộc sống gia đình mộc mạc, không tô vẽ, không dàn dựng đã chạm đến hàng triệu người xem. Năm 2022, khi TikTok bắt đầu phát triển mạnh tại Việt Nam, bà Tuyết cùng gia đình bắt đầu chia sẻ nội dung về đồ ăn vặt. Cộng đồng yêu mến không chỉ xem mà còn đặt hàng - và Ăn Cùng Bà Tuyết ra đời từ chính nhu cầu và sự ủng hộ đó.", multiline: true, sortOrder: 663 },
  { id: "about-current-story-3", key: "about_current_story_3", group: "Giới thiệu - Nội dung đang hiển thị", label: "Câu chuyện - đoạn 3", value: "Trong quá trình phục vụ khách hàng, đội ngũ Ăn Cùng Bà Tuyết nhận ra một thực tế: người Việt Nam vẫn còn nhiều định kiến với đồ ăn vặt nội địa: về chất lượng, về nguồn gốc, về sự thiếu vắng những thương hiệu Việt thật sự đứng sau sản phẩm. Từ nhận thức đó, Ăn Cùng Bà Tuyết xác định sứ mệnh của mình: để người Việt Nam tự hào về đồ ăn vặt của chính mình, với sản phẩm do người Việt làm chủ, nguyên liệu rõ ràng, quy trình kiểm soát được.", multiline: true, sortOrder: 664 },
  { id: "about-current-story-4", key: "about_current_story_4", group: "Giới thiệu - Nội dung đang hiển thị", label: "Câu chuyện - đoạn 4", value: "Đến nay, Ăn Cùng Bà Tuyết đã xây dựng những nhà máy sản xuất thực phẩm tại Hà Nội và Thái Nguyên, sử dụng những nguồn nguyên liệu chất lượng cao nhập khẩu từ châu Âu, sản phẩm được bảo hiểm trách nhiệm bởi PVI, và phân phối tại hàng nghìn điểm bán trên toàn quốc, từ tạp hóa gần trường học đến các sàn thương mại điện tử.", multiline: true, sortOrder: 665 },
  { id: "about-current-proof-1", key: "about_current_proof_1", group: "Giới thiệu - Nội dung đang hiển thị", label: "Bằng chứng 1", value: "Nguyên liệu chân gà chất lượng cao nhập khẩu từ Châu Âu", multiline: true, sortOrder: 666 },
  { id: "about-current-proof-2", key: "about_current_proof_2", group: "Giới thiệu - Nội dung đang hiển thị", label: "Bằng chứng 2", value: "Hai nhà máy sản xuất phục vụ hàng triệu khách hàng", multiline: true, sortOrder: 667 },
  { id: "about-current-proof-3", key: "about_current_proof_3", group: "Giới thiệu - Nội dung đang hiển thị", label: "Bằng chứng 3", value: "Bảo hiểm trách nhiệm sản phẩm khẳng định đồng hành bảo vệ quyền lợi khách hàng", multiline: true, sortOrder: 668 },
  { id: "about-current-proof-4", key: "about_current_proof_4", group: "Giới thiệu - Nội dung đang hiển thị", label: "Bằng chứng 4", value: "Phân phối toàn quốc qua hệ thống bán lẻ và thương mại điện tử", multiline: true, sortOrder: 669 },
  { id: "about-current-video-caption", key: "about_current_video_caption", group: "Giới thiệu - Nội dung đang hiển thị", label: "Chú thích dưới video", value: "Xem quy trình nhà máy thực tế", multiline: false, sortOrder: 670 },
  { id: "about-current-beliefs-title", key: "about_current_beliefs_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Tiêu đề định hướng", value: "Chúng tôi tin vào điều gì", multiline: false, sortOrder: 671 },
  { id: "about-current-mission-label", key: "about_current_mission_label", group: "Giới thiệu - Nội dung đang hiển thị", label: "Sứ mệnh - nhãn", value: "Sứ mệnh", multiline: false, sortOrder: 672 },
  { id: "about-current-mission-title", key: "about_current_mission_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Sứ mệnh - tiêu đề", value: "Để người Việt Nam tự hào về đồ ăn vặt của chính mình", multiline: true, sortOrder: 673 },
  { id: "about-current-mission-description", key: "about_current_mission_description", group: "Giới thiệu - Nội dung đang hiển thị", label: "Sứ mệnh - mô tả", value: "Đồ ăn vặt Việt Nam từ lâu chịu nhiều định kiến: về chất lượng, về nguồn gốc, về sự thiếu vắng những thương hiệu nội địa thật sự đứng sau sản phẩm. Ăn Cùng Bà Tuyết ra đời và phát triển với mong muốn thay đổi điều đó: xây dựng một thương hiệu đồ ăn vặt mà người Việt có thể yên tâm chọn, tự hào giới thiệu, và biết rõ ai đang chịu trách nhiệm.", multiline: true, sortOrder: 674 },
  { id: "about-current-vision-label", key: "about_current_vision_label", group: "Giới thiệu - Nội dung đang hiển thị", label: "Tầm nhìn - nhãn", value: "Tầm nhìn", multiline: false, sortOrder: 675 },
  { id: "about-current-vision-title", key: "about_current_vision_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Tầm nhìn - tiêu đề", value: "Vươn tầm quốc tế & khẳng định chất lượng Việt", multiline: true, sortOrder: 676 },
  { id: "about-current-vision-description", key: "about_current_vision_description", group: "Giới thiệu - Nội dung đang hiển thị", label: "Tầm nhìn - mô tả", value: "Ăn Cùng Bà Tuyết khao khát trở thành một thương hiệu đồ ăn vặt được tin yêu và ủng hộ tại Việt Nam, xa hơn nữa là đưa đồ ăn vặt Việt Nam ra thị trường quốc tế.", multiline: true, sortOrder: 677 },
  { id: "about-current-philosophy-label", key: "about_current_philosophy_label", group: "Giới thiệu - Nội dung đang hiển thị", label: "Triết lý - nhãn", value: "Triết lý kinh doanh", multiline: false, sortOrder: 678 },
  { id: "about-current-philosophy-title", key: "about_current_philosophy_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Triết lý - tiêu đề", value: "Làm thật và làm khác biệt", multiline: true, sortOrder: 679 },
  { id: "about-current-philosophy-description", key: "about_current_philosophy_description", group: "Giới thiệu - Nội dung đang hiển thị", label: "Triết lý - mô tả", value: "Ăn Cùng Bà Tuyết không chọn cách làm đồ ăn vặt giống những gì thị trường đã có. Nguyên liệu nhập khẩu từ châu Âu khi phần lớn ngành hàng dùng nguồn nguyên liệu không rõ xuất xứ. Đầu tư và gánh chịu rất nhiều rủi ro khi xây dựng nhà máy hàng chục tỷ đồng thay vì đi thuê nhà máy gia công để tiết kiệm chi phí. Mua bảo hiểm trách nhiệm sản phẩm cho từng gói hàng vài nghìn đồng chỉ với mong muốn được bảo vệ và đồng hành với khách hàng được nhiều hơn. Mỗi quyết định đều đắt hơn, chậm hơn, rủi ro hơn nhưng chúng tôi vẫn chọn chỉ cần nó có thể mang đến nhiều lợi ích hơn cho khách hàng.", multiline: true, sortOrder: 680 },
  { id: "about-current-core-title", key: "about_current_core_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Tiêu đề giá trị cốt lõi", value: "Giá trị cốt lõi", multiline: false, sortOrder: 681 },
  { id: "about-current-core-1-title", key: "about_current_core_1_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 1 - tiêu đề", value: "An toàn", multiline: false, sortOrder: 682 },
  { id: "about-current-core-1-description", key: "about_current_core_1_description", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 1 - mô tả", value: "Sản phẩm phải đạt chuẩn từ nguyên liệu đến thành phẩm, không thỏa hiệp để đổi lấy giá rẻ, sức khoẻ khách hàng là quan trọng nhất và không có ngoại lệ.", multiline: true, sortOrder: 683 },
  { id: "about-current-core-2-title", key: "about_current_core_2_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 2 - tiêu đề", value: "Minh bạch", multiline: false, sortOrder: 684 },
  { id: "about-current-core-2-description", key: "about_current_core_2_description", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 2 - mô tả", value: "Nguồn gốc nguyên liệu, quy trình sản xuất, chứng nhận chất lượng, tất cả phải được công khai để khách hàng có thể tự kiểm chứng.", multiline: true, sortOrder: 685 },
  { id: "about-current-core-3-title", key: "about_current_core_3_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 3 - tiêu đề", value: "Trách nhiệm", multiline: false, sortOrder: 686 },
  { id: "about-current-core-3-description", key: "about_current_core_3_description", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 3 - mô tả", value: "Khi có vấn đề, Ăn Cùng Bà Tuyết luôn sẵn sàng nhận trách nhiệm và không né tránh. Sản phẩm được bảo hiểm trách nhiệm PVI là 1 phần trong những nỗ lực này.", multiline: true, sortOrder: 687 },
  { id: "about-current-core-4-title", key: "about_current_core_4_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 4 - tiêu đề", value: "Quyết liệt", multiline: false, sortOrder: 688 },
  { id: "about-current-core-4-description", key: "about_current_core_4_description", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 4 - mô tả", value: "Để có thể phát triển và mang lại nhiều giá trị hơn cho khách hàng, chúng tôi luôn quyết liệt làm tốt hơn mỗi ngày để phục vụ được khách hàng tốt và tốt hơn nữa.", multiline: true, sortOrder: 689 },
  { id: "about-current-core-5-title", key: "about_current_core_5_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 5 - tiêu đề", value: "Người Việt làm chủ", multiline: false, sortOrder: 690 },
  { id: "about-current-core-5-description", key: "about_current_core_5_description", group: "Giới thiệu - Nội dung đang hiển thị", label: "Giá trị 5 - mô tả", value: "Ăn Cùng Bà Tuyết ngay từ khi thành lập đến nay luôn là doanh nghiệp do người Việt sáng lập, vận hành và sở hữu, với khát vọng đưa đồ ăn vặt Việt Nam lên bản đồ thế giới.", multiline: true, sortOrder: 691 },
  { id: "about-current-slogan", key: "about_current_slogan", group: "Giới thiệu - Nội dung đang hiển thị", label: "Khẩu hiệu cuối phần giá trị", value: "Ăn vặt thì phải ăn cùng Bà Tuyết", multiline: false, sortOrder: 692 },
  { id: "about-current-cta-title", key: "about_current_cta_title", group: "Giới thiệu - Nội dung đang hiển thị", label: "CTA cuối trang - tiêu đề", value: "Tìm hiểu thêm về chất lượng và quy trình sản xuất hoặc liên hệ với chúng tôi", multiline: true, sortOrder: 693 },
  { id: "about-current-cta-1-text", key: "about_current_cta_1_text", group: "Giới thiệu - Nội dung đang hiển thị", label: "CTA 1 - chữ", value: "Xem trang Chất lượng", multiline: false, sortOrder: 694 },
  { id: "about-current-cta-1-link", key: "about_current_cta_1_link", group: "Giới thiệu - Nội dung đang hiển thị", label: "CTA 1 - link", value: "/chat-luong", multiline: false, sortOrder: 695 },
  { id: "about-current-cta-2-text", key: "about_current_cta_2_text", group: "Giới thiệu - Nội dung đang hiển thị", label: "CTA 2 - chữ", value: "Xem sản phẩm", multiline: false, sortOrder: 696 },
  { id: "about-current-cta-2-link", key: "about_current_cta_2_link", group: "Giới thiệu - Nội dung đang hiển thị", label: "CTA 2 - link", value: "/san-pham", multiline: false, sortOrder: 697 },
  { id: "about-current-cta-3-text", key: "about_current_cta_3_text", group: "Giới thiệu - Nội dung đang hiển thị", label: "CTA 3 - chữ", value: "Liên hệ với chúng tôi", multiline: false, sortOrder: 698 },
  { id: "about-current-cta-3-link", key: "about_current_cta_3_link", group: "Giới thiệu - Nội dung đang hiển thị", label: "CTA 3 - link", value: "/lien-he", multiline: false, sortOrder: 699 },
  ...
  { id: "sales-hero-label", key: "sales_hero_label", group: "Điểm bán - Hero", label: "Nhãn đầu trang", value: "Điểm bán chính thức", multiline: false, sortOrder: 900 },
  { id: "sales-hero-title", key: "sales_hero_title", group: "Điểm bán - Hero", label: "Tiêu đề lớn", value: "Mua đúng kênh, nhận đúng hàng Bà Tuyết.", multiline: true, sortOrder: 901 },
  { id: "sales-hero-description", key: "sales_hero_description", group: "Điểm bán - Hero", label: "Mô tả", value: "Tập trung toàn bộ điểm bán offline, kênh online chính thức và cách nhận diện hàng chính hãng trên cùng một trang.", multiline: true, sortOrder: 902 },
  { id: "sales-hero-offline-button", key: "sales_hero_offline_button", group: "Điểm bán - Hero", label: "Nút tìm điểm bán", value: "Tìm điểm bán", multiline: false, sortOrder: 903 },
  { id: "sales-hero-online-button", key: "sales_hero_online_button", group: "Điểm bán - Hero", label: "Nút kênh online", value: "Kênh online", multiline: false, sortOrder: 904 },
  { id: "sales-metric-offline-label", key: "sales_metric_offline_label", group: "Điểm bán - Hero", label: "Số liệu điểm bán - nhãn", value: "Điểm phân phối", multiline: false, sortOrder: 905 },
  { id: "sales-metric-online-label", key: "sales_metric_online_label", group: "Điểm bán - Hero", label: "Số liệu online - nhãn", value: "Kênh online", multiline: false, sortOrder: 906 },
  { id: "sales-metric-guide-label", key: "sales_metric_guide_label", group: "Điểm bán - Hero", label: "Số liệu hướng dẫn - nhãn", value: "Bước nhận diện", multiline: false, sortOrder: 907 },
  { id: "sales-offline-title", key: "sales_offline_title", group: "Điểm bán - Hệ thống offline", label: "Tiêu đề", value: "Hệ thống điểm bán offline", multiline: true, sortOrder: 910 },
  { id: "sales-offline-description", key: "sales_offline_description", group: "Điểm bán - Hệ thống offline", label: "Mô tả", value: "Danh sách cửa hàng, đại lý và khu vực phân phối đang được công bố để khách hàng dễ chọn đúng kênh mua.", multiline: true, sortOrder: 911 },
  { id: "sales-online-title", key: "sales_online_title", group: "Điểm bán - Kênh online", label: "Tiêu đề", value: "Kênh online chính thức", multiline: true, sortOrder: 920 },
  { id: "sales-online-open-label", key: "sales_online_open_label", group: "Điểm bán - Kênh online", label: "Chữ mở kênh", value: "Mở kênh", multiline: false, sortOrder: 921 },
  { id: "sales-online-empty", key: "sales_online_empty", group: "Điểm bán - Kênh online", label: "Thông báo khi trống", value: "Hiện chưa có kênh online chính thức nào được công bố.", multiline: true, sortOrder: 922 },
  { id: "sales-auth-label", key: "sales_auth_label", group: "Điểm bán - Nhận diện chính hãng", label: "Nhãn", value: "Nhận diện", multiline: false, sortOrder: 930 },
  { id: "sales-auth-title", key: "sales_auth_title", group: "Điểm bán - Nhận diện chính hãng", label: "Tiêu đề", value: "Cách tránh mua nhầm hàng không rõ nguồn", multiline: true, sortOrder: 931 },
  { id: "sales-auth-description", key: "sales_auth_description", group: "Điểm bán - Nhận diện chính hãng", label: "Mô tả", value: "Phần này giúp khách kiểm tra trước khi đặt hàng: nguồn mua, bao bì, tem nhãn và kênh hỗ trợ.", multiline: true, sortOrder: 932 },
  { id: "sales-auth-step-1-title", key: "sales_auth_step_1_title", group: "Điểm bán - Nhận diện chính hãng", label: "Bước 1 - tiêu đề", value: "Mua đúng kênh", multiline: false, sortOrder: 933 },
  { id: "sales-auth-step-1-description", key: "sales_auth_step_1_description", group: "Điểm bán - Nhận diện chính hãng", label: "Bước 1 - mô tả", value: "Ưu tiên điểm bán/kênh online được công bố trên website.", multiline: true, sortOrder: 934 },
  { id: "sales-auth-step-2-title", key: "sales_auth_step_2_title", group: "Điểm bán - Nhận diện chính hãng", label: "Bước 2 - tiêu đề", value: "Kiểm tra bao bì", multiline: false, sortOrder: 935 },
  { id: "sales-auth-step-2-description", key: "sales_auth_step_2_description", group: "Điểm bán - Nhận diện chính hãng", label: "Bước 2 - mô tả", value: "Bao bì, nhãn, tên sản phẩm và thông tin NSX/HSD phải rõ ràng.", multiline: true, sortOrder: 936 },
  { id: "sales-auth-step-3-title", key: "sales_auth_step_3_title", group: "Điểm bán - Nhận diện chính hãng", label: "Bước 3 - tiêu đề", value: "Giữ bằng chứng mua", multiline: false, sortOrder: 937 },
  { id: "sales-auth-step-3-description", key: "sales_auth_step_3_description", group: "Điểm bán - Nhận diện chính hãng", label: "Bước 3 - mô tả", value: "Lưu đơn hàng/hóa đơn để được hỗ trợ khi cần khiếu nại.", multiline: true, sortOrder: 938 },
  { id: "sales-cta-label", key: "sales_cta_label", group: "Điểm bán - CTA", label: "Nhãn", value: "Cần hỗ trợ?", multiline: false, sortOrder: 940 },
...
function withDefaultHomeTexts(items: HomeTextItem[]) {
  ...
  return DEFAULT_HOME_TEXTS.map((defaultItem) => ({
    ...defaultItem,
    ...(byKey.get(defaultItem.key) || {}),
    value: defaultItem.key === "products_landing_description"
      && byKey.get(defaultItem.key)?.value?.trim() === LEGACY_PRODUCTS_LANDING_DESCRIPTION
      ? PRODUCTS_LANDING_DESCRIPTION
      : byKey.get(defaultItem.key)?.value ?? defaultItem.value,
    id: byKey.get(defaultItem.key)?.id || defaultItem.id,
